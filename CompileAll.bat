...
javac -proc:none -Xlint:-options -d compiled -cp "src;lib/*" src/test/EnhancedEmbeddingQualityTest.java
javac -proc:none -Xlint:-options -d compiled -cp "src;lib/*" src/test/DebugEmbeddingIssues.java
