...
public class FaceDetection {
    ...
    public FaceDetectionResult detectFaceForPreview(Mat frame) {
        model.FaceDetectionResult result = faceDetector.detectFaceForPreview(frame);
    ...
    public FaceCaptureResult captureAndStoreFaceImages(Student student, int numberOfImages,
        ...
        model.FaceCaptureResult result = faceCaptureService.captureAndStoreFaceImages(student, numberOfImages, callback);
    ...
    public static class FaceDetectionResult extends model.FaceDetectionResult {
        public FaceDetectionResult(List<model.FaceCandidate> faces) {
            super(faces);
        }
    }

    public static class FaceCandidate extends model.FaceCandidate {
        public FaceCandidate(Rect rect, double confidence) {
            super(rect, confidence);
        }
    }

    public static class FaceCaptureResult extends model.FaceCaptureResult {
