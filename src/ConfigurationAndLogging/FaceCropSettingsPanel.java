...
/**
 * Responsive settings panel with optional capture/save controls.
 */
public class FaceCropSettingsPanel extends JPanel {
    ...
    // Backwards-compatible: two-arg constructor defaults to showing the Save button
    ...
    private JPanel buildControls(Boolean showCaptureButton, Boolean showSaveButton) {
        ...
        saveButton.addActionListener(a -> {
            ...
            else AppConfig.getInstance().save();
