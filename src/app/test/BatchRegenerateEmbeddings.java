...
public class BatchRegenerateEmbeddings {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("• Lenient capture - accepts all detectable faces, filters weak embeddings");
        System.out.println();
        ...
        for (File studentFolder : studentFolders) {
            ...
            File[] imageFiles = studentFolder.listFiles((dir, name) -> {
                String lower = name.toLowerCase();
                return lower.endsWith(".jpg") || lower.endsWith(".png");
            });
            if (imageFiles == null || imageFiles.length == 0) {
                System.out.println("No .jpg/.png images found in " + studentFolder.getName() + ", skipping...");
                System.out.println();
                continue;
            }

            System.out.println("Found " + imageFiles.length + " images (.jpg/.png)");
