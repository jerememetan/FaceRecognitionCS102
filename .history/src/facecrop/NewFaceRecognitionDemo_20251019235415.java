...
public class NewFaceRecognitionDemo extends JFrame implements IConfigChangeListener {
    ...
    private void initializeModelData() {
        ...
        personLabels.clear();
                    ...
                    try {
                        // Image quality check (if implemented)
                        ...
                        if (personScores.isEmpty()) {
                            displayText = "unknown";
                            AppLogger.info("[Reject] Face rejected: No valid person scores.");
                        } else {
                            ...
                            if (accept) {
                                ...
                                lastDisplayText = "unknown";
                                lastDisplayColor = new Scalar(0, 0, 255);
                                AppLogger.info("[Reject] Face rejected: Did not meet recognition thresholds.");
                            }
