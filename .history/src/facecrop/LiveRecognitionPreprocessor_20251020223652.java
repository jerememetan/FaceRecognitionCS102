...
*
* For TRAINING/ENROLLMENT, use FaceEmbeddingGenerator.preprocessForTraining() instead.
*/
...
System.out.println("⚠️ Face alignment not available - continuing without i
}
} catch (Exception e) {
