...
public class FaceDetection {
    ...
    public FaceCaptureResult captureAndStoreFaceImages(Student student, int numberOfImages,
        ...
        if (capturedCount > 0) {
            ...
            batchResult = this.processCapturedImages(capturedImages, imageProcessor, progressCallback);
    ...
    public FaceEmbeddingGenerator.BatchProcessingResult processCapturedImages(
        ...
        if (progressCallback != null) {
            progressCallback.onProgress("Processing captured images with face detection...");
        }
        ...
        // Note: Quality analysis (outlier/weak detection) would be handled by FaceEmbeddingGenerator
        // if needed, but for now we'll return basic results
        return new FaceEmbeddingGenerator.BatchProcessingResult(processedCount, 0, 0,
                "Processed " + processedCount + " images with face detection");
    }
