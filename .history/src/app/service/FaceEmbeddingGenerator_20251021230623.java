...
public class FaceEmbeddingGenerator {
    ...
    private byte[] generateDeepEmbedding(Mat faceImage, Rect faceRect) {
        try {
            ...
            // *** CRITICAL FIX: Add face alignment if faceRect is provided ***
            Mat aligned;
            if (faceRect != null && aligner != null && aligner.isInitialized()) {
                aligned = aligner.align(processed, faceRect);
                processed.release();
    ...
    public int detectAndRemoveOutliers(java.util.List<byte[]> embeddings,
    ...
    public int detectAndRemoveWeakEmbeddings(java.util.List<byte[]> embeddings,
            java.util.List<String> embeddingPaths,
            java.util.List<String> imagePaths) {
