...
public class FaceDetection {
    ...
    public FaceCaptureResult captureAndStoreFaceImages(Student student, int numberOfImages,
        ...
        if (capturedCount > 0) {
            ...
            // ✅ FIX: Don't re-detect faces in saved images - they are already cropped faces!
            // The saved images are already the cropped face regions, so use whole image as face
